...
\input{project-description/Goals-and-Objectives.tex}      % Section 2.2
\input{project-description/requirements.tex}    % Section 2.3 - needs work, expanding requirements, better house of quality
...
\input{design-details/web.tex}                  % Section 5.4
                                                % section 5.5 - integration design add section
