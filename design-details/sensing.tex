...
(placeholder: Image representing the whole system)
...
(placeholder: Image of the spectrum, include reference)
...
(placeholder: image of soil drill from paper, include reference)
...
(placeholder: image from Newport, include reference)
